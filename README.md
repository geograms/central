...
| **Market** | Decentralized marketplace for peer-to-peer commerce | Shop management, inventory tracking, order lifecycle (12 statuses), verified reviews, FAQ system, multilanguage support, crypto & traditional payments | [market-format-specification.md](docs/collections/types/market-format-specification.md) |
