...
/// How prominently a card is drawn, given what is selected or found.
enum CardEmphasis {
  /// The current node: fully opaque, always drawn in front.
  selected,

  /// Linked to the current node, or a search hit.
  highlighted,

  /// Nothing is selected, so everything reads normally.
  normal,
