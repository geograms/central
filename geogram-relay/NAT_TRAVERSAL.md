...
# See I2P_INTEGRATION.md for detailed setup

# Relay accessible via .i2p domain
# Provides anonymity and NAT traversal
```
...
- GitHub Issues: https://github.com/geograms/central/issues
- Documentation: https://github.com/geograms/central/tree/main/geogram-relay
